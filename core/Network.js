      ...
      if(node.isTip && this.settings.EnableCanalization) {
        ...
        while(currentNode.parent != null) {
          ...
          if(currentNode.parent.thickness < currentNode.thickness + .07) {
            let thickness  = currentNode.thickness + .03;
            if(thickness > this.settings.MaxThickness){
              thickness = this.settings.MaxThickness;
            }

            currentNode.parent.thickness = thickness
          }
